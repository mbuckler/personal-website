...
1.  [Install Hugo](https://georgecushen.com/create-your-website-with-hugo/#installing-hugo) and create a new website by typing the following commands in your _Terminal_ or _Command Prompt_ app:
...
Before upgrading for the first time, the remote _origin_ repository should be renamed to _upstream_:
